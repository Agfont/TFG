...
class Network(Model):
    ...
    def __init__(self, dim, batch_norm, dropout, rec_dropout, header, task,
        ...
        if task in ['decomp', 'ihm', 'ph', 'los']:  #!Modified:customized los to binary classification
        ...
        pX = []  # GRU processed version of cX
        for x in cX:
            p = x
    ...
    def say_name(self):
        return "{}.n{}.szc{}{}{}{}.dep{}".format('k_channel_wise_grus',
                                                 self.dim,
                                                 self.size_coef,
