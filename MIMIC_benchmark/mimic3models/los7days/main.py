...
from mimic3models.los7days import utils
...
parser.add_argument('--data', type=str, help='Path to the data of length of stay task',
                    default=os.path.join(os.path.dirname(__file__), '../../data/los7days/'))
...
if normalizer_state is None:
    normalizer_state = 'los_ts{}.input_str:{}.start_time:zero.normalizer'.format(args.timestep, args.imputation)
...
if args.mode == 'train':
    ...
    metrics_callback = keras_utils.LOSCustomizedMetrics(train_data=train_raw,
                                                              val_data=val_raw,
